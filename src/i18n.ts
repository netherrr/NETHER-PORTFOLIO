...
export const STRINGS: Record<string, Entry> = {
  ...
  'kpinder.like': { ua: 'лайк', en: 'like' },
  'kpinder.nope': { ua: 'ні', en: 'nope' },
  'kpinder.like2': { ua: 'лайк', en: 'like' },
  'kpinder.nope2': { ua: 'ні', en: 'nope' },
  'kpinder.like3': { ua: 'лайк', en: 'like' },
  'kpinder.nope3': { ua: 'ні', en: 'nope' },
  ...
  'about.l2': {
    ua: 'Вірю в AI як у нову матерію продуктів — з нього я будую живих персонажів, а не інтерфейси з кнопками.',
    en: 'I believe AI is the new matter of products — I build living characters out of it, not interfaces with buttons.',
  },
  'about.l3': {
    ua: 'Від ідеї до запуску — тижні, а не місяці. Найкращий тест продукту — випустити його у світ.',
    en: 'From idea to launch in weeks, not months. The best test of a product is setting it loose.',
  },
